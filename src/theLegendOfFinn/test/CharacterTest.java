...
public class CharacterTest {
	...
	public void playerShouldRecoverLife() throws InterruptedException {
		...
		boolean recoveredCorrectLife = player.getCurrentHP() == playerHP + enemy.getHPBounty() || player.getCurrentHP() == player.getMaxHP();
	...
	public void closeEnoughIsAccurate() {
		...
		assertFalse("Some enemies are far away", newEnemy.closeEnough(player));
		assertTrue("Some enemies are close", enemy.closeEnough(player));
	}
